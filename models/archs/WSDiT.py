...
from basicsr.models.archs.histoformer_arch import Attention_histogram, FeedForward
from basicsr.models.archs.attentions import HiLo
...
class DTB(nn.Module):
    ...
    def __init__(self, dim,  ffn_factor, bias, LayerNorm_type, num_heads=8,mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                 agent_num=49, window=14, reduction=8):
    ...
    def forward(self, x, t):
        ...
        x = x + self.attn(self.norm1(x) + t+add)
        ###########################yuan
        # x1=x
        ...
        x = x + self.ffn(self.norm_ff1(x)+t)
        return x, t
